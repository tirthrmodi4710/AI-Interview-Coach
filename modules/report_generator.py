...
def generate_pdf(
    ...
    try:
        ...
        pdf.set_xy(10, 8)
        pdf.cell(0, 10, "AI Interview Coach - Report", ln=True)

        pdf.set_font("Helvetica", "", 12)
        pdf.set_xy(10, 22)
        pdf.cell(0, 7, _sanitize(f"Candidate: {candidate_name}"), ln=True)
        ...
        pdf.cell(0, 10, "Generated by AI Interview Coach", align="C")
